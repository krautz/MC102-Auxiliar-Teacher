...
# Verifica se o Usuario possui o comando curl  instaldo
    ...
    curl https://susy.ic.unicamp.br:9999/mc102coord/$num/dados/$arq.in --insecure -O -s 
    curl https://susy.ic.unicamp.br:9999/mc102coord/$num/dados/$arq.res --insecure -O -s 
    PARADA=""
...
then
    ...
    then
        ...
        nohup firefox https://susy.ic.unicamp.br:9999/mc102coord/$num & > /dev/null
        rm nohup.out -f
        clear
    fi
else
